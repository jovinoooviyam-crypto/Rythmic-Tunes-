  ...
  return (
    <nav className="sidebar">
      <ul className="list-unstyled">
        <strong style={{display:"flex",justifyContent:"center",fontSize:"30px"}}>MOOTIFY</strong>
        <p style={{textAlign:"center", fontSize:12,color:"rgba(239, 239, 239, 1)",}}>This is the place where you can hear every songs that i uploaded.</p>
